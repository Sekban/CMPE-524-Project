...
data_directory_keywords = ['No_of_Iterations_SA']
test_size_keywords = ['Test_9']
...
if __name__ == "__main__":    
  for data_directory_keyword in data_directory_keywords:
    for test_size_keyword in test_size_keywords:
        ...
        with open('TestData/Phase_2/' + data_directory_keyword + '/' + test_size_keyword + '/initialsetup.csv', encoding='utf8') as csvfile:
        ...
        with open('TestData/Phase_2/' + data_directory_keyword + '/' + test_size_keyword + '/concentrator_capacity_initialcost.csv', encoding='utf8') as csvfile:
          readCSV = csv.reader(csvfile, delimiter=',')
          next(readCSV)
          for row in readCSV:
        ...
        with open('TestData/Phase_2/' + data_directory_keyword + '/' + test_size_keyword + '/terminal_demand_assigncost.csv', encoding='utf8') as csvfile:
          readCSV = csv.reader(csvfile, delimiter=',')
          next(readCSV)
          for row in readCSV:
        ...
        # Writing to file SA
        simulated_annealing_file = open('Results/Phase_2/' + data_directory_keyword + '/' + test_size_keyword + '/SimulatedAnnealing.txt', 'w')
        ...
        greedy_file = open('Results/Phase_2/' + data_directory_keyword + '/' + test_size_keyword + '/Greedy.txt', 'w')
